    ...
    <footer style={{ background: '#0A1F14', padding: '60px 24px 30px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 40, marginBottom: 50 }} className="mob-col">
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              <div style={{ width: 32, height: 32, borderRadius: 6, background: 'linear-gradient(135deg, #00E676, #00C853)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '0.9rem', fontWeight: 700, color: '#0A1F14' }}>N</span>
              </div>
              <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '1.1rem', fontWeight: 700, color: '#fff' }}>NaijaComply</span>
            </div>
          ...
          <div>
            <h4 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '0.85rem', fontWeight: 600, color: '#fff', marginBottom: 16 }}>Product</h4>
            {['Dashboard', 'E-Invoice', 'Calculator', 'Agents', 'Pricing'].map(item => (
              <button key={item} onClick={() => document.querySelector(`#${item.toLowerCase().replace(' ', '-')}`)?.scrollIntoView({ behavior: 'smooth' })}
                style={{ display: 'block', background: 'none', border: 'none', padding: '6px 0', fontFamily: "'Inter', sans-serif", fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)', cursor: 'pointer', textAlign: 'left' }}>
                {item}
              </button>
            ))}
          </div>
          <div>
            <h4 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '0.85rem', fontWeight: 600, color: '#fff', marginBottom: 16 }}>Company</h4>
          ...
          <div>
            <h4 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: '0.85rem', fontWeight: 600, color: '#fff', marginBottom: 16 }}>Legal</h4>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
          <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.8rem', color: 'rgba(255,255,255,0.3)' }}>
